...
<html>
  <head>
    ...
    <link href="sunsouxian/main.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="sunsouxian/main.js" charset="utf-8"></script>
  </head>
  <body class="easyui-layout">
  		<div data-options="region:'north',border:false" title="人员管理系统--孙守贤" style="height:60px;">
	  				<div id="toolbar">
